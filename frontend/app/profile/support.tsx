...
const FAQ = [
  ...
  },
  {
    ...
    a: "Care Passport의 진단은 제품 상태 관리를 위한 참고 자료이며 정품 감정 서비스가 아닙니다. 정품 여부는 공식 매장을 통해 문의해주세요.",
  },
  {
  ...
  {
    q: "알림이 오지 않아요",
    a: "프로필의 알림 설정과 휴대폰 설정의 Care Passport 알림 권한을 모두 확인해주세요. 일부 알림은 새로운 진단 결과가 생성된 이후 발송됩니다.",
  },
];
const CENTERS = [
  {
